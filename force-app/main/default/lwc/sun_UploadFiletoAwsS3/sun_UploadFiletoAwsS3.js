...
import getUploadConfiguration from "@salesforce/apex/SUN_UploadFileToAwsS3Controller.getUploadConfiguration";
import displayUploadedFiles from "@salesforce/apex/SUN_UploadFileToAwsS3Controller.displayUploadedFiles";
import insertAttachmentRecord from "@salesforce/apex/SUN_UploadFileToAwsS3Controller.insertAttachmentRecord";
import getAllFolderName from "@salesforce/apex/SUN_UploadFileToAwsS3Controller.getAllFolderName";
import getRecordDetail from "@salesforce/apex/SUN_UploadFileToAwsS3Controller.getRecordDetail";
import { ShowToastEvent } from "lightning/platformShowToastEvent";
import { loadStyle, loadScript } from "lightning/platformResourceLoader";
import awsJS from "@salesforce/resourceUrl/awsJS";

// Import custom labels
import SelectFolder from '@salesforce/label/c.SUN_Select_Folder';
import AwsS3Files from '@salesforce/label/c.SUN_AWS_S3_Files';
import progress from '@salesforce/label/c.SUN_progress';
import uploadingthefile from '@salesforce/label/c.SUN_Uploading_the_file';
import filetouploader from '@salesforce/label/c.SUN_file_to_uploader';
import Followingfilesuploaded from '@salesforce/label/c.SUN_Following_files_uploaded';
import upload from '@salesforce/label/c.SUN_Upload';
import photos from '@salesforce/label/c.SUN_Add_Interior_or_Exterior_Property_Photos';
