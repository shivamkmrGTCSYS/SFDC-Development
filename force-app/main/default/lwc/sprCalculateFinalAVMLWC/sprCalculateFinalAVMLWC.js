...
import doCallout from '@salesforce/apex/SPR_CalculateFinalAVMPrice.calculateOnOpportunity';
import {ShowToastEvent} from 'lightning/platformShowToastEvent';

export default class SprCalculateFinalAVMLWC extends LightningElement {
    response='';
    isLoaded = false;
    @api recordId
    @api invoke(){
